...
icon = "https://i.hizliresim.com/nyVbLl.png" \
       "readme/star.png"
class_name = "Support"
...
class Support(Module):
    ...
    def get_social_channels(self, msg, client):
        channels = []
        channels.append({"act": True, "prt": 1, "id": 1, "stid": "Youtube",
                         "dsctn": f"Kanala Abone Ol."
                         f"Revizyon: {self.server.revision}",
                         "ttl": "Youtube", "https://i.hizliresim.com/nyVbLl.png": icon,
                         "lnk": "https://www.youtube.com/channel/UCMqCV1krggwbxf4nmIYmSPA"})
